        ...
        <div class="row">
            ...
            <div class="card custom-card">
                ...
                <div class="card-header justify-content-between">
                    <div class="card-title"> @lang('Edit Pos Manager') </div>
                </div>

                <div class="card-body">


                <form wire:submit.prevent="updatePosManager">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="newImage" type="file" id="image" class="form-control" placeholder="@lang('Image')" />
                            @error('newImage') <span class="text-danger">{{ $message }}</span> @enderror
                            @if ($image)
                                <img src="{{ $image }}" alt="@lang('old avatar')" class="img-fluid rounded-circle" style="width: 100px; height: 100px;">
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            <select wire:model="branch_id" id="branch_id" class="form-control" required>
                                 @foreach ($branches as $branch)
                                    <option value="{{ $branch->id }}" {{ $branch_id == $branch->id ? 'selected' : '' }}>{{ $branch->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="newPassword" type="password" id="password" class="form-control" placeholder="@lang('Password')" />
