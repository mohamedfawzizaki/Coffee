        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">@lang('Edit Product')</h4>
                                    ...
                                    @else
                                        <div id="product-sizes">
                                            ...
                                            @foreach ($newSizes as $index => $size)
                                                <div class="row mt-3" wire:key="size-row-{{ $index }}">
                                                    @foreach ($locales as $locale)
                                                        <div class="col-lg-4">
                                                            <div class="mb-3">
                                                                <label class="form-label">@lang('Size.' . $locale . '.title')</label>
                                                                <input type="text" class="form-control"
                                                                    wire:model="newSizes.{{ $index }}.{{ $locale }}.title"
                                                                    placeholder="@lang('Size.' . $locale . '.title')">
                                                                @error('newSizes.' . $index . '.' . $locale . '.title')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group has-validation mb-3">
                                                                ...
                                                                <input type="number" step="0.01" class="form-control"
                                                                    wire:model="newSizes.{{ $index }}.price"
                                                                    placeholder="@lang('Price')">
                                                                @error('newSizes.' . $index . '.price')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group has-validation mb-3">
                                                                <span class="input-group-text">$</span>
                                                                <input type="number" step="0.01" class="form-control"
                                                                    wire:model="newSizes.{{ $index }}.cost_price"
                                                                    placeholder="@lang('Cost Price')">
                                                                @error('newSizes.' . $index . '.cost_price')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <input class="form-control" type="file"
                                        accept="image/png, image/gif, image/jpeg, image/webp" wire:model="newImage">

                                    @if ($newImage)
                                        <div class="mt-3">
                                            <label class="form-label text-success">@lang('Image Preview')</label>
                                            <img src="{{ $newImage->temporaryUrl() }}" alt="@lang('Product Image Preview')"
                                    ...
                                    @elseif (!empty($image))
                                        <div class="mt-3">
                                            ...
                                            <img src="{{ $image }}" alt="@lang('Product Image')"
                                                class="img-fluid border rounded"
                                                style="width: 150px; height: 150px; object-fit: cover;" />
                                        </div>
                                    @endif
